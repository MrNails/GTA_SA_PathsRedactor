...
{
    void NotifyInformation(string message, string title = "Information");
    void NotifyWarning(string message, string title = "Warning");
    void NotifyError(string message, string title = "Error");
    QuestionResults NotifyQuestion(string message, string title);
    QuestionResults NotifyQuestionYesNo(string message, string title);
}
